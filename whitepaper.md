...
|--------|-----------|-------------|
| WASI Preview 1 Module | `.wasm` | Legacy plain wasm module, supports `wasi_snapshot_preview1`; requires `wasi-preview1` feature on `edge-runtime` |
