...
mod tests {
    ...
    #[test]
    #[cfg_attr(windows, ignore = "wasmtime trap delivery triggers STATUS_STACK_BUFFER_OVERRUN on Windows")]
    ...
    /// STATUS_STACK_BUFFER_OVERRUN in the Windows test runner.
    #[test]
    #[cfg_attr(windows, ignore = "wasmtime epoch signals trigger STATUS_STACK_BUFFER_OVERRUN on Windows")]
