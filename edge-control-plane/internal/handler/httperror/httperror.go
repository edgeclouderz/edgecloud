...
// HTTP status code and ErrorCode. Used by middleware that needs a
// status not covered by the named helpers above (e.g. 503 Service
// Unavailable). The named helpers (BadRequest, Unauthorized, etc.)
// are preferred where they apply; this is the escape hatch.
